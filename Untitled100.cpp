...
user.setAccountNo(id);
 ...
 ofstream outfile("C:/Users/theki/OneDrive/Desktop/new.txt", ios::app);
 if(!outfile){
...
ifstream infile("C:/Users/theki/OneDrive/Desktop/new.txt");
ofstream outfile("C:/Users/theki/OneDrive/Desktop/new temp.txt");
if(!infile || !outfile){
cout<<"\tError: File Can't Open!"<<endl;
}
...
outfile.close();
infile.close();
remove("C:/Users/theki/OneDrive/Desktop/new.txt");
rename("C:/Users/theki/OneDrive/Desktop/new temp.txt", "C:/Users/theki/OneDrive/Desktop/new.txt");
Sleep(5000);
}
